...
ap = argparse.ArgumentParser(description="Genera un archivo obj_dictionary.h a partir de csv de od")
ap.add_argument("csv", help="archivo csv de entrada")
ap.add_argument("-o", "--output", default=None, help="archivo .h de salida (por defecto <csv>_od.h)")
args = ap.parse_args()

csv_path = Path(args.csv)
if not csv_path.exists():
    raise FileNotFoundError(f"Archivo csv de entrada no encontrado: {csv_path}")

out_path = Path(args.output) if args.output else Path("src") / f"{csv_path.stem}_od.h"
...
csv_out_path = csv_path.with_name(f"{csv_path.stem}_od.csv")
